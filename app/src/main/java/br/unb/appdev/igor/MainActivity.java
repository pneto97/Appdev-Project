...
public class MainActivity extends AppCompatActivity {
    ...
    public enum Fragments {
        HOME,NEWADVENTURE,ONGOING,NEWSESSION,CONTA,TELAEDICAO1, TELAEDICAO2, TELAEDICAO3;
    }
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch(item.getItemId()){
                    ...
                    case R.id.nav_conta:
                        ...
                        ContaConfigFragment contaConfig= new ContaConfigFragment();

                        MainActivity.fragmentManager.beginTransaction().replace(
                                R.id.fragment_container, contaConfig,
...
//        }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch(item.getItemId()) {
            ...
            case R.id.action_editar:
                ...
                //adicionando o fragment modo edicao
                ModoEdicaoFragment modoEdicao = (ModoEdicaoFragment) getSupportFragmentManager().findFragmentByTag("MODOEDICAO");
                if (modoEdicao != null && modoEdicao.isVisible()) {
                    ...
                    ft.add(R.id.fragment_container, new ModoEdicaoFragment(), "MODOEDICAO");
                    ft.commit();
                }
    ...
    {
        //removendo o modo edição com o no onBack
        ModoEdicaoFragment modoEdicao = (ModoEdicaoFragment) getSupportFragmentManager().findFragmentByTag("MODOEDICAO");
        if (modoEdicao != null && modoEdicao.isVisible()) {
            FragmentManager fm = getSupportFragmentManager();
        ...
        else if(fragAtual == Fragments.HOME) {
